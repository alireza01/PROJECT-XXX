...
>(({ className, asChild, isActive, ...props }, ref) => {
  ...
  return (
    <Comp
      ref={ref}
      className={cn(
        "group/menu-button flex w-full items-center gap-2 rounded-md px-2 text-sm font-medium transition-colors hover:bg-sidebar-hover hover:text-sidebar-foreground-hover",
...
export const SidebarMenuSubItem = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("px-2", className)} {...props} />
  )
)
...
export const SidebarInset = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn("absolute inset-2 rounded-lg bg-sidebar-inset", className)}
      {...props}
    />
  )
)
